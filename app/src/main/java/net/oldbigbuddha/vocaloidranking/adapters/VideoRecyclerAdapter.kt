...
class VideoRecyclerAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): VideoRecyclerAdapter.ViewHolder? = ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_video, parent, false))
